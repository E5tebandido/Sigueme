...
var loadWebNavSignIn = (img) => {
    ...
    <li><a href="javascript:;"  onclick="sethistorialaprove()" style="margin-top: -0.2rem; color: gainsboro;">Ver donaciones</a></li> 
...
var loadBred = (user,img) => {
    ...
    <li>
        ...
        <div class="background">
            <img src="../assets/images/sidenavmenu.png" width="100%" style="filter: brightness(100%);">
        </div>
